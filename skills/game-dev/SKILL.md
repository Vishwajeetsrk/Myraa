...
name: game-dev
title: "Game Dev"
description: "Build playable browser games (Babylon.js) end-to-end using the godogen production pipeline adapted to Manus. Use when..."
category: "Creative & Design"
image: "icon.svg"
icon: "icon.svg"
version: "2.5.0"
tags: ["automation", "creative", "dev", "game", "myraa-skill"]
---

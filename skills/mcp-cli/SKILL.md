...
name: mcp-cli
title: "Mcp Cli"
description: "Interface for MCP (Model Context Protocol) servers via CLI. Use when you need to interact with external tools, APIs, ..."
category: "Coding & Development"
image: "icon.svg"
icon: "icon.svg"
version: "2.5.0"
tags: ["automation", "cli", "coding", "mcp", "myraa-skill"]
---

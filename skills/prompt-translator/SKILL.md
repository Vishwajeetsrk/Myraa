...
description: "把一条 AI 视频提示词从源模型(如 Sora 2)的写法风格转换为目标模型(如 Kling 3.0 / Wan 2.7 / Veo 3.1 等)的最佳实践写法。基于 110 条 10 场景 × 11 模型对照基准数据(prompts..."
category: "AI & Intelligence"
image: "icon.svg"
icon: "icon.svg"
version: "2.5.0"
tags: ["ai", "automation", "myraa-skill", "prompt", "translator"]
---

' ==============================================================================
'  MIRA AI OS (v7.5.0 APEX Master) - Windows Silent VBScript Master Installer
'  Technology: WScript.Shell / Scripting.FileSystemObject
' ==============================================================================
Option Explicit

Dim WshShell, FSO, strInstallPath, strSourcePath
...
strSourcePath = "C:\Users\Vishwajeet\Music\Mira"
...
WshShell.RegWrite "HKCU\Software\Microsoft\Windows\CurrentVersion\Run\MIRA_AI_OS", """" & strLauncherBat & """", "REG_SZ"
On Error GoTo 0

' 4. Show Completion Alert
MsgBox "MIRA AI OS (v7.5.0 APEX Master) has been installed successfully!" & vbCrLf & vbCrLf & _
       "• Location: " & strSourcePath & vbCrLf & _
       "• Identity: Mira (Female AI Companion)" & vbCrLf & _
       "• Voice Biometrics: Operator Vishwajeet Verified" & vbCrLf & _
       "• Desktop Shortcut: 'MIRA AI OS' Created", vbInformation, "MIRA Setup Complete"
